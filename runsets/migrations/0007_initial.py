...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'runsets_runset', (
            ...
            ('machine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['runsets.Machine'], blank=True)),
    ...
    models = {
        ...
        u'runsets.runset': {
            ...
            'machine': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['runsets.Machine']", 'blank': 'True'}),
